...
func Test_samAv2_SETConfigurationSettings(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := SETConfigurationSettings(tt.args.allowDumpSessionKey, tt.args.keepIV, tt.args.keyType, true, tt.args.authKey, tt.args.disableKeyEntry, tt.args.lockKey, tt.args.disableWritingKeyPICC, tt.args.disableDecryption, tt.args.disableEncryption, tt.args.disableVerifyMAC, tt.args.disableGenMAC); !reflect.DeepEqual(got, tt.want) {
